#
#  Be sure to run `pod spec lint ZYThumbnailTableView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "liuzhiyi1992" => "55137840@qq.com" }
  # Or just: s.author    = "liuzhiyi1992"
  # s.authors            = { "liuzhiyi1992" => "55137840@qq.com" }
  # s.social_media_url   = "http://twitter.com/liuzhiyi1992"
  ...
  s.source       = { :git => "https://github.com/liuzhiyi1992/ZYThumbnailTableView.git", :tag => "1.0.1" }
  ...
  s.source_files  = "ZYThumbnailTableViewSource/Classes/**/*.{h,m,swift}"
